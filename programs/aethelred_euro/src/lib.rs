...
declare_id!("H3DagyBbC86U62PVkPV6pgtJcuuhhK7FpWwoLWsYHboL");

#[program]
pub mod aethelred_euro {
    use super::*;
    ...
    pub fn mint_euro(ctx: Context<MintEuro>, amount: u64) -> Result<()> {
        require!(
